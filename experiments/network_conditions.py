...
def netem_conditions(interface: str, loss_percent: float = 0.0, latency_ms: int = 0, jitter_ms: int = 0, bandwidth_mbps: int = 0):
    ...
    loss_percent, latency_ms, jitter_ms, bandwidth_mbps:
